...
public class LoginServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            Users  user =dao.getUserByEmailAndPassword(email, pass);
            System.out.println(user);
            if(user==null)
            {
//                out.println("<h1>No such user with email: "+email+" in the database</h1>");
                Message msg = new Message("Invalid credentials,Please Register if new User!!","error!","alert-danger");
